    ...
    public class UserController : ControllerBase{
        ...
        public async Task<IActionResult> GetByEmail([FromBody] string email)
        {
            try
            {
                ...
                {
                    return Ok(new ResultViewModel{
                        Message = "Nenhum usuário foi encontrado co email informado.",
                        Success = true,
                        Data = user
                    });
                }
                ...
                return Ok(new ResultViewModel{
                    Message = "Usuário encotrado cm sucesso!",
                    Success = true,
                    Data = user
                });
            }
        ...
        public async Task<IActionResult> SearchByName([FromBody] string nome)
        {
            try
            {
